...
class vtkPolyDataMapper(vtkMapper):
    ...
    def GetMaximumNumberOfTriangles(self, __a:'vtkRenderer') -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkHardwareWindow(vtkmodules.vtkCommonCore.vtkWindow):
    ...
    def SetPlatform(self, arg:str) -> None: ...
...
class vtkInteractorStyle(vtkInteractorObserver):
    ...
    def Dolly(self) -> None: ...
    @staticmethod
    def DollyToPosition(fact:float, position:MutableSequence[int], renderer:'vtkRenderer') -> None: ...
    ...
    @staticmethod
    def TranslateCamera(renderer:'vtkRenderer', toX:int, toY:int, fromX:int, fromY:int) -> None: ...
...
class vtkRenderMaterialLibrary(vtkmodules.vtkCommonCore.vtkObject):
    class ParameterType(int):
        BOOLEAN:'ParameterType'
        COLOR_RGB:'ParameterType'
        COLOR_RGBA:'ParameterType'
        FLOAT:'ParameterType'
        FLOAT_DATA:'ParameterType'
        INT:'ParameterType'
        NORMALIZED_FLOAT:'ParameterType'
        TEXTURE:'ParameterType'
        VEC2:'ParameterType'
        VEC3:'ParameterType'
        VEC4:'ParameterType'
    def __init__(self, **properties:Any) -> None: ...
    def AddMaterial(self, nickname:str, implname:str) -> None: ...
    def AddShaderVariable(self, nickname:str, variablename:str, numVars:int, x:Sequence[float]) -> None: ...
    def AddTexture(self, nickname:str, varname:str, tex:'vtkTexture', texturename:str=..., filename:str=...) -> None: ...
    def GetDoubleShaderVariable(self, nickname:str, varname:str) -> Tuple[float, float]: ...
    def GetDoubleShaderVariableList(self, nickname:str) -> Tuple[str, str]: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetTexture(self, nickname:str, varname:str) -> 'vtkTexture': ...
    def GetTextureFilename(self, nickname:str, varname:str) -> str: ...
    def GetTextureList(self, nickname:str) -> Tuple[str, str]: ...
    def GetTextureName(self, nickname:str, varname:str) -> str: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def LookupImplName(self, nickname:str) -> str: ...
    def NewInstance(self) -> 'vtkRenderMaterialLibrary': ...
    def ReadBuffer(self, Buffer:str) -> bool: ...
    def ReadFile(self, FileName:str) -> bool: ...
    def RemoveAllShaderVariables(self, nickname:str) -> None: ...
    def RemoveAllTextures(self, nickname:str) -> None: ...
    def RemoveMaterial(self, nickname:str) -> None: ...
    def RemoveShaderVariable(self, nickname:str, variablename:str) -> None: ...
    def RemoveTexture(self, nickname:str, varname:str) -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkRenderMaterialLibrary': ...
    def WriteBuffer(self, writeImageInline:bool=True) -> str: ...
    def WriteFile(self, filename:str, writeImageInline:bool=False) -> None: ...
...
class vtkRenderWindow(vtkmodules.vtkCommonCore.vtkWindow):
    ...
    def SetFullScreen(self, __a:int) -> None: ...
    def SetHardwareWindow(self, win:'vtkHardwareWindow') -> None: ...
...
class vtkRenderWindowInteractor(vtkmodules.vtkCommonCore.vtkObject):
    ...
    hardware_window:'getset_descriptor'
    initialized:'getset_descriptor'
    interactor_observers:'getset_descriptor'
    ...
    track_interactor_observer_instances:'getset_descriptor'
    ...
    def GetInteractorObservers(self) -> 'vtkCollection': ...
    ...
    def GetTrackInteractorObserverInstances(self) -> bool: ...
    ...
    def SetTrackInteractorObserverInstances(self, _arg:bool) -> None: ...
    ...
    def TrackInteractorObserverInstancesOff(self) -> None: ...
    def TrackInteractorObserverInstancesOn(self) -> None: ...
...
class vtkRenderer(vtkViewport):
    ...
    skybox_blur_enabled:'getset_descriptor'
    skybox_blur_radius:'getset_descriptor'
    ...
    def GetSkyboxBlurEnabled(self) -> bool: ...
    def GetSkyboxBlurRadius(self) -> float: ...
    ...
    def SetSkyboxBlurEnabled(self, _arg:bool) -> None: ...
    def SetSkyboxBlurRadius(self, _arg:float) -> None: ...
    ...
    def SkyboxBlurEnabledOff(self) -> None: ...
    def SkyboxBlurEnabledOn(self) -> None: ...
    def StereoMidpoint(self) -> None: ...
