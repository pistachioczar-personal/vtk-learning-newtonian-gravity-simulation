...
class vtkXMLReader(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @overload
    def CanReadFile(self, stream:'vtkResourceStream') -> bool: ...
...
class vtkXMLGenericDataObjectReader(vtkXMLDataReader):
    ...
    def __init__(self, **properties:Any) -> None: ...
    def CanReadFileWithDataType(self, dsname:str) -> int: ...
    @staticmethod
...
class vtkXMLUniformGridAMRReader(vtkXMLPartitionedDataSetCollectionReader):
