...
class vtkAMRContourFilter(vtkmodules.vtkCommonExecutionModel.vtkPartitionedDataSetAlgorithm):
    ...
    def NewInstance(self) -> 'vtkAMRContourFilter': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkAMRContourFilter': ...
    def SetComputeNormals(self, val:bool) -> None: ...
    def SetComputeScalars(self, val:bool) -> None: ...
    def SetContourValues(self, values:Sequence[float]) -> None: ...
    def SetGenerateTriangles(self, val:bool) -> None: ...
...
class vtkAMRInterfaceFilter(vtkmodules.vtkCommonExecutionModel.vtkPartitionedDataSetAlgorithm):
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkAMRInterfaceFilter': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkAMRInterfaceFilter': ...
