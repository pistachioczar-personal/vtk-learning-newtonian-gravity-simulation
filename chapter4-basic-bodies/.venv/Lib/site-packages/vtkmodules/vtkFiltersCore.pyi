...
class vtk3DLinearGridPlaneCutter(vtkmodules.vtkCommonExecutionModel.vtkDataObjectAlgorithm):
    ...
    merge_points_off:'getset_descriptor'
    merge_points_on:'getset_descriptor'
    number_of_threads_used:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    ...
    def SetMergePointsOff(self) -> None: ...
    def SetMergePointsOn(self) -> None: ...
...
class vtkAppendCompositeDataLeaves(vtkmodules.vtkCommonExecutionModel.vtkCompositeDataSetAlgorithm):
    ...
    def UseImplicitArrayOff(self) -> None: ...
    def UseImplicitArrayOn(self) -> None: ...
...
class vtkProbeFilter(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    snapping_radius:'getset_descriptor'
    source:'getset_descriptor'
    source_connection:'getset_descriptor'
    source_data:'getset_descriptor'
    spatial_match:'getset_descriptor'
    ...
    def GetSnappingRadius(self) -> float: ...
    def GetSource(self) -> 'vtkDataObject': ...
    def GetSpatialMatch(self) -> int: ...
    def GetTolerance(self) -> float: ...
    ...
    def SetCellLocatorPrototype(self, cellLocator:'vtkAbstractCellLocator') -> None: ...
    def SetComputeTolerance(self, _arg:bool) -> None: ...
    ...
    def SetSnappingRadius(self, _arg:float) -> None: ...
    def SetSourceConnection(self, algOutput:'vtkAlgorithmOutput') -> None: ...
    def SetSourceData(self, source:'vtkDataObject') -> None: ...
    def SetSpatialMatch(self, _arg:int) -> None: ...
    def SetTolerance(self, _arg:float) -> None: ...
...
class vtkContourHelper(object):
    ...
    @overload
    def __init__(self, locator:'vtkIncrementalPointLocator', outVerts:'vtkCellArray', outLines:'vtkCellArray', outPolys:'vtkCellArray', inPd:'vtkPointData', inCd:'vtkCellData', outPd:'vtkPointData', outCd:'vtkCellData', outputTriangles:bool) -> None: ...
...
class vtkConvexHull(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    dimension:'getset_descriptor'
    generate_poly_data:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GeneratePolyDataOff(self) -> None: ...
    def GeneratePolyDataOn(self) -> None: ...
    def GetDimension(self) -> int: ...
    def GetDimensionMaxValue(self) -> int: ...
    def GetDimensionMinValue(self) -> int: ...
    def GetGeneratePolyData(self) -> bool: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    @overload
    def IsPointWithinConvexHull(self, x:float, y:float, z:float, tol:float=1e-8) -> bool: ...
    @overload
    def IsPointWithinConvexHull(self, point:Sequence[float], tol:float=1e-8) -> bool: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkConvexHull': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkConvexHull': ...
    def SetDimension(self, _arg:int) -> None: ...
    def SetGeneratePolyData(self, _arg:bool) -> None: ...
...
class vtkDelaunay2D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    use_hilbert_sorter:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    ...
    def GetUseHilbertSorter(self) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetUseHilbertSorter(self, _arg:int) -> None: ...
    def UseHilbertSorterOff(self) -> None: ...
    def UseHilbertSorterOn(self) -> None: ...
...
class vtkHilbertCurveSorter(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    compute_permutation_only:'getset_descriptor'
    permutation:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def ComputePermutationOnlyOff(self) -> None: ...
    def ComputePermutationOnlyOn(self) -> None: ...
    def GetComputePermutationOnly(self) -> bool: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetPermutation(self) -> 'vtkIdList': ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkHilbertCurveSorter': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkHilbertCurveSorter': ...
    def SetComputePermutationOnly(self, _arg:bool) -> None: ...
...
class vtkResampleWithDataSet(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    def SetSnappingRadius(self, arg:float) -> None: ...
    def SetSourceConnection(self, algOutput:'vtkAlgorithmOutput') -> None: ...
    def SetSourceData(self, source:'vtkDataObject') -> None: ...
...
class vtkSurfaceNets3D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def SetNumberOfLabels(self, number:int) -> None: ...
    def SetOptimizedSmoothingStencils(self, __a:bool) -> None: ...
...
class vtkSurfaceNetsAtlas(vtkmodules.vtkCommonExecutionModel.vtkPartitionedDataSetCollectionAlgorithm):
    class ExtractionModes(int): ...
    class OutputStyles(int): ...
    EXTRACT_ALL:'ExtractionModes'
    EXTRACT_LABEL_SET:'ExtractionModes'
    OUTPUT_STYLE_ALL:'OutputStyles'
    OUTPUT_STYLE_BOUNDARY:'OutputStyles'
    background_label:'getset_descriptor'
    extraction_mode:'getset_descriptor'
    generate_patches:'getset_descriptor'
    generate_regions:'getset_descriptor'
    number_of_label_names:'getset_descriptor'
    number_of_labels:'getset_descriptor'
    number_of_patches:'getset_descriptor'
    number_of_selected_labels:'getset_descriptor'
    output_style:'getset_descriptor'
    resolve_non_manifold_points:'getset_descriptor'
    selected_labels:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AddLabelName(self, label:int, name:str) -> None: ...
    def AddSelectedLabel(self, label:int) -> None: ...
    @overload
    def AreAdjacent(self, label0:int, label1:int) -> bool: ...
    @overload
    def AreAdjacent(self, name0:str, name1:str) -> bool: ...
    def ClearLabelNames(self) -> None: ...
    def ClearSelectedLabels(self) -> None: ...
    def GeneratePatchesOff(self) -> None: ...
    def GeneratePatchesOn(self) -> None: ...
    def GenerateRegionsOff(self) -> None: ...
    def GenerateRegionsOn(self) -> None: ...
    @overload
    def GenerateSelectedLabels(self, numLabels:int, rangeStart:int, rangeEnd:int) -> None: ...
    @overload
    def GenerateSelectedLabels(self, numLabels:int, range:MutableSequence[int]) -> None: ...
    @overload
    def GenerateSelectedLabels(self, rangeStart:int, rangeEnd:int) -> None: ...
    @overload
    def GetAdjacentLabels(self, label:int) -> Tuple[int, int]: ...
    @overload
    def GetAdjacentLabels(self, name:str) -> Tuple[int, int]: ...
    def GetBackgroundLabel(self) -> int: ...
    def GetExtractionMode(self) -> int: ...
    def GetExtractionModeMaxValue(self) -> int: ...
    def GetExtractionModeMinValue(self) -> int: ...
    def GetGeneratePatches(self) -> bool: ...
    def GetGenerateRegions(self) -> bool: ...
    @overload
    def GetLIDForLabel(self, label:int) -> int: ...
    @overload
    def GetLIDForLabel(self, name:str) -> int: ...
    def GetLabelForLID(self, lid:int) -> int: ...
    def GetLabelForName(self, name:str) -> int: ...
    def GetLabelName(self, label:int) -> str: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetNumberOfLabelNames(self) -> int: ...
    def GetNumberOfLabels(self) -> int: ...
    ...
    def GetOutputStyleMaxValue(self) -> int: ...
    def GetOutputStyleMinValue(self) -> int: ...
    def GetPatchCellCount(self, patchID:int) -> int: ...
    @overload
    def GetPatchID(self, label0:int, label1:int) -> int: ...
    @overload
    def GetPatchID(self, name0:str, name1:str) -> int: ...
    def GetPatchLabels(self, patchID:int, labels:MutableSequence[int]) -> None: ...
    @overload
    def GetPatchesForLabel(self, label:int) -> Tuple[int, int]: ...
    @overload
    def GetPatchesForLabel(self, name:str) -> Tuple[int, int]: ...
    def GetResolveNonManifoldPoints(self) -> bool: ...
    def GetSelectedLabel(self, i:int) -> int: ...
    def GetSelectedLabels(self) -> Tuple[int, int]: ...
    @overload
    def HasLabel(self, label:int) -> bool: ...
    @overload
    def HasLabel(self, name:str) -> bool: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkSurfaceNetsAtlas': ...
    def RemoveLabelName(self, label:int) -> None: ...
    def RemoveSelectedLabel(self, label:int) -> None: ...
    def ResolveNonManifoldPointsOff(self) -> None: ...
    def ResolveNonManifoldPointsOn(self) -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkSurfaceNetsAtlas': ...
    def SetBackgroundLabel(self, _arg:int) -> None: ...
    def SetExtractionMode(self, _arg:int) -> None: ...
    def SetExtractionModeToAll(self) -> None: ...
    def SetExtractionModeToLabelSet(self) -> None: ...
    def SetGeneratePatches(self, _arg:bool) -> None: ...
    def SetGenerateRegions(self, _arg:bool) -> None: ...
    def SetLabelName(self, label:int, name:str) -> None: ...
    def SetNumberOfSelectedLabels(self, n:int) -> None: ...
    def SetOutputStyle(self, _arg:int) -> None: ...
    def SetOutputStyleToAll(self) -> None: ...
    def SetOutputStyleToBoundary(self) -> None: ...
    def SetResolveNonManifoldPoints(self, _arg:bool) -> None: ...
    def SetSelectedLabel(self, i:int, label:int) -> None: ...
    def SetSelectedLabels(self, labels:Sequence[int]) -> None: ...
