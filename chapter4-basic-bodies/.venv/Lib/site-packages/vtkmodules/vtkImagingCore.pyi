...
class vtkImageBinaryThreshold(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    class ThresholdFunction(int): ...
    THRESHOLD_BETWEEN:'ThresholdFunction'
    THRESHOLD_LOWER:'ThresholdFunction'
    THRESHOLD_UPPER:'ThresholdFunction'
    ...
    def SetReplaceIn(self, _arg:bool) -> None: ...
    def SetReplaceOut(self, _arg:bool) -> None: ...
    def SetThresholdFunction(self, _arg:int) -> None: ...
