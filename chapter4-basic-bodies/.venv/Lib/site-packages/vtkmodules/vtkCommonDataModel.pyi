...
VTK_HIGHER_ORDER_QUADRILATERAL:int
...
class vtkAMRBox(object):
    ...
    @overload
    def Add(self, i:int, j:int, k:int) -> None: ...
    @overload
    def Add(self, ijk:Sequence[int]) -> None: ...
...
class vtkOverlappingAMRMetaData(vtkAMRMetaData):
    ...
    def FindGrids(self, q:MutableSequence[float], level:int, gridIds:MutableSequence[int]) -> bool: ...
...
class vtkLocator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    tolerance_default_value:'getset_descriptor'
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetToleranceDefaultValue(self) -> float: ...
...
class vtkAbstractCellLocator(vtkLocator):
    ...
    @overload
    def FindCell(self, x:MutableSequence[float], tol2:float) -> int: ...
    @overload
    ...
    def FindCellsAlongLine(self, p1:Sequence[float], p2:Sequence[float], tol:float, cells:'vtkIdList') -> None: ...
    def FindCellsAlongPlane(self, o:Sequence[float], n:Sequence[float], tol:float, cells:'vtkIdList') -> None: ...
    ...
    def InsideCellBounds(self, x:MutableSequence[float], cell_ID:int, tol:float=0.0) -> bool: ...
    @overload
...
class vtkDataSet(vtkDataObject):
    ...
    def GetPoints(self) -> 'vtkPoints': ...
    def GetSampledMaxCellLength2(self, numSamples:int=100) -> float: ...
    @overload
...
class vtkCartesianGrid(vtkDataSet):
    ...
    @overload
    @staticmethod
    def GetData(info:'vtkInformation') -> 'vtkCartesianGrid': ...
    @overload
    @staticmethod
    def GetData(v:'vtkInformationVector', i:int=0) -> 'vtkCartesianGrid': ...
...
class vtkCellArray(vtkAbstractCellArray):
    ...
    def GetCellSize(self, cellId:int) -> int: ...
    def GetConnectivityAOSArray32(self) -> 'vtkAOSDataArrayTemplate_IiE': ...
    def GetConnectivityAOSArray64(self) -> 'vtkAOSDataArrayTemplate_IxE': ...
    ...
    def GetNumberOfOffsets(self) -> int: ...
    def GetOffset(self, cellId:int) -> int: ...
    def GetOffsetsAOSArray32(self) -> 'vtkAOSDataArrayTemplate_IiE': ...
    def GetOffsetsAOSArray64(self) -> 'vtkAOSDataArrayTemplate_IxE': ...
    def GetOffsetsAffineArray32(self) -> 'vtkAffineArray_IiE': ...
    def GetOffsetsAffineArray64(self) -> 'vtkAffineArray_IxE': ...
    ...
    @overload
    def SetData(self, __a:'vtkAOSDataArrayTemplate_IiE', connectivity:'vtkAOSDataArrayTemplate_IiE') -> None: ...
    @overload
    def SetData(self, __a:'vtkAOSDataArrayTemplate_IxE', connectivity:'vtkAOSDataArrayTemplate_IxE') -> None: ...
    @overload
    def SetData(self, __a:'vtkAffineArray_IiE', connectivity:'vtkAOSDataArrayTemplate_IiE') -> None: ...
    @overload
    def SetData(self, __a:'vtkAffineArray_IxE', connectivity:'vtkAOSDataArrayTemplate_IxE') -> None: ...
    @overload
...
class vtkCellGridSummaryInformationQuery(vtkCellGridQuery):
    attribute_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetAttributeName(self) -> str: ...
    def GetNumberOfDOF(self, att:'vtkCellAttribute') -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOrderRange(self, __a:'vtkCellAttribute', range:MutableSequence[int]) -> None: ...
    def Initialize(self) -> bool: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkCellGridSummaryInformationQuery': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkCellGridSummaryInformationQuery': ...
...
class vtkFindCellStrategy(vtkmodules.vtkCommonCore.vtkObject):
    def __init__(self, **properties:Any) -> None: ...
    def ConvertToCellLocator(self) -> 'vtkAbstractCellLocator': ...
...
class vtkDataAssembly(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetChild(self, parent:int, name:str) -> int: ...
...
class vtkDataAssemblyUtilities(vtkmodules.vtkCommonCore.vtkObject):
    def __init__(self, **properties:Any) -> None: ...
    @staticmethod
    def CategoryHierarchy() -> str: ...
    @staticmethod
    def CategoryHierarchyName() -> str: ...
    @staticmethod
    def CategoryTransformedHierarchy() -> str: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def GenerateCompositeDataSetFromHierarchy(input:'vtkPartitionedDataSetCollection') -> 'vtkCompositeDataSet': ...
    @staticmethod
    ...
    @staticmethod
    def HasCompatibilityHierarchy(input:'vtkPartitionedDataSetCollection') -> bool: ...
    @staticmethod
    def HierarchyName() -> str: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsCompatibilityHierarchy(hierarchy:'vtkDataAssembly') -> bool: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkDist2Tuple(object):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, id:int, d2:float) -> None: ...
    @overload
    def __init__(self, __a:'vtkDist2Tuple') -> None: ...

class vtkDist2TupleArray(object):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, __a:'vtkDist2TupleArray') -> None: ...
...
class vtkJumpAndWalkCellLocator(vtkAbstractCellLocator):
    ...
    def FindCell(self, x:MutableSequence[float], cell:'vtkCell', genCell:'vtkGenericCell', cellId:int, tol2:float, subId:int, pcoords:MutableSequence[float], weights:MutableSequence[float]) -> int: ...
    @overload
    def FindClosestPointWithinRadius(self, x:MutableSequence[float], radius:float, closestPoint:MutableSequence[float], genCell:'vtkGenericCell', cellId:int, subId:int, dist2:float, inside:int) -> int: ...
    @overload
    def FindClosestPointWithinRadius(self, x:MutableSequence[float], radius:float, closestPoint:MutableSequence[float], cellId:int, subId:int, dist2:float) -> int: ...
    @overload
    def FindClosestPointWithinRadius(self, x:MutableSequence[float], radius:float, closestPoint:MutableSequence[float], cell:'vtkGenericCell', cellId:int, subId:int, dist2:float) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkJumpAndWalkCellLocator': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkJumpAndWalkCellLocator': ...
    def SetNumberOfClosestPoints(self, _arg:int) -> None: ...
    def SetPointLocator(self, _arg:'vtkAbstractPointLocator') -> None: ...
    def ShallowCopy(self, locator:'vtkAbstractCellLocator') -> None: ...
...
class vtkLine(vtkCell):
    ...
    @staticmethod
    def Evaluate(n:Sequence[float], o:Sequence[float], x:Sequence[float]) -> float: ...
    def EvaluateLocation(self, subId:int, pcoords:Sequence[float], x:MutableSequence[float], weights:MutableSequence[float]) -> None: ...
    def EvaluatePosition(self, x:Sequence[float], closestPoint:MutableSequence[float], subId:int, pcoords:MutableSequence[float], dist2:float, weights:MutableSequence[float]) -> int: ...
    def GetCellDimension(self) -> int: ...
    def GetCellType(self) -> int: ...
...
class vtkMarchingCellsContourCases(object):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, __a:'vtkMarchingCellsContourCases') -> None: ...
...
class vtkPolyDataMaterial(vtkmodules.vtkCommonCore.vtkObject):
    diffuse_color_name:'getset_descriptor'
    shininess_name:'getset_descriptor'
    specular_color_name:'getset_descriptor'
    texture_uri_name:'getset_descriptor'
    transparency_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    @staticmethod
    def GetDiffuseColorName() -> str: ...
    @overload
    @staticmethod
    def GetField(obj:'vtkDataObject', name:str) -> Tuple[str, str]: ...
    @overload
    @staticmethod
    def GetField(obj:'vtkDataObject', name:str, defaultValue:Sequence[float]) -> Tuple[float, float]: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    @staticmethod
    def GetShininessName() -> str: ...
    @staticmethod
    def GetSpecularColorName() -> str: ...
    @staticmethod
    def GetTextureURIName() -> str: ...
    @staticmethod
    def GetTransparencyName() -> str: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkPolyDataMaterial': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkPolyDataMaterial': ...
    @overload
    @staticmethod
    def SetField(obj:'vtkDataObject', name:str, value:str) -> None: ...
    @overload
    @staticmethod
    def SetField(obj:'vtkDataObject', name:str, values:Sequence[str]) -> None: ...
    @overload
    @staticmethod
...
class vtkPolygon(vtkCell):
    ...
    @staticmethod
    def ComputeInteriorCircle(p:'vtkPoints', numPts:int, ids:Sequence[int], center:MutableSequence[float], radius2:float) -> bool: ...
    @overload
    @staticmethod
...
class vtkPolyhedron(vtkCell3D):
    ...
    @overload
    def ClipWithContext(self, value:float, scalars:'vtkDataArray', locator:'vtkIncrementalPointLocator', connectivity:'vtkCellArray', inPd:'vtkPointData', outPd:'vtkPointData', inCd:'vtkCellData', cellId:int, outCd:'vtkCellData', insideOut:int, outFaces:'vtkCellArray', outFaceLocs:'vtkCellArray') -> None: ...
    @overload
    def ClipWithContext(self, value:float, scalars:'vtkDataArray', locator:'vtkIncrementalPointLocator', connectivity:'vtkCellArray', inPd:'vtkPointData', outPd:'vtkPointData', inCd:'vtkCellData', cellId:int, outCd:'vtkCellData', insideOut:int, outUG:'vtkUnstructuredGrid') -> None: ...
...
class vtkStaticCellLocator(vtkAbstractCellLocator):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def InsideCellBounds(self, x:MutableSequence[float], cellId:int, tol:float=0.0) -> bool: ...
    @overload
    def IntersectWithLine(self, p1:Sequence[float], p2:Sequence[float], tol:float, t:float, x:MutableSequence[float], pcoords:MutableSequence[float], subId:int, cellId:int, cell:'vtkGenericCell') -> int: ...
    @overload
    def IntersectWithLine(self, p1:Sequence[float], p2:Sequence[float], tol:float, points:'vtkPoints', cellIds:'vtkIdList', cell:'vtkGenericCell') -> int: ...
...
class vtkStaticPointLocator(vtkAbstractPointLocator):
    ...
    @overload
    def FindClosestPointWithinRadius(self, radius:float, x:Sequence[float], inputDataLength:float, dist2:float) -> int: ...
    def FindNPointsInShell(self, N:int, x:Sequence[float], results:'vtkDist2TupleArray', minDist2:float=..., sort:bool=True, petals:'vtkDoubleArray'=...) -> float: ...
    @overload
    def FindPointsWithinRadius(self, R:float, x:Sequence[float], result:'vtkIdList') -> None: ...
    @overload
    def FindPointsWithinRadius(self, R:float, x:float, y:float, z:float, result:'vtkIdList') -> None: ...
...
class vtkStaticPointLocator2D(vtkAbstractPointLocator):
    ...
    @overload
    def FindClosestPointWithinRadius(self, radius:float, x:Sequence[float], inputDataLength:float, dist2:float) -> int: ...
    def FindNPointsInAnnulus(self, N:int, x:Sequence[float], results:'vtkDist2TupleArray', minDist2:float=..., sort:bool=True, petals:'vtkDoubleArray'=...) -> float: ...
    @overload
    def FindPointsWithinRadius(self, R:float, x:Sequence[float], result:'vtkIdList') -> None: ...
    @overload
    def FindPointsWithinRadius(self, R:float, x:float, y:float, z:float, result:'vtkIdList') -> None: ...
...
class vtkTriangle(vtkCell):
    ...
    def Derivatives(self, subId:int, pcoords:Sequence[float], values:Sequence[float], dim:int, derivs:MutableSequence[float]) -> None: ...
    @staticmethod
    def DistanceToTriangle(x:Sequence[float], p1:Sequence[float], p2:Sequence[float], p3:Sequence[float]) -> float: ...
    def EvaluateLocation(self, subId:int, pcoords:Sequence[float], x:MutableSequence[float], weights:MutableSequence[float]) -> None: ...
    def EvaluatePosition(self, x:Sequence[float], closestPoint:MutableSequence[float], subId:int, pcoords:MutableSequence[float], dist2:float, weights:MutableSequence[float]) -> int: ...
    def GetCellDimension(self) -> int: ...
    def GetCellType(self) -> int: ...
    ...
    @staticmethod
    def SolidAngle(x:Sequence[float], p1:Sequence[float], p2:Sequence[float], p3:Sequence[float]) -> float: ...
    @staticmethod
...
class vtkXMLDataElement(vtkmodules.vtkCommonCore.vtkObject):
    ...
    id:'getset_descriptor'
    name:'getset_descriptor'
    nested_elements:'getset_descriptor'
    number_of_attributes:'getset_descriptor'
