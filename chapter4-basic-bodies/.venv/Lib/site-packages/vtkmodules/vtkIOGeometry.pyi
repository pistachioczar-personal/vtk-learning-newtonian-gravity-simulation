...
class vtkGLTFDocumentLoader(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def LoadModelMetaDataFromStream(self, stream:'vtkResourceStream', loader:'vtkURILoader'=..., quiet:bool=False) -> bool: ...
...
class vtkOBJWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    texture_file_name:'getset_descriptor'
    use_relative_texture_path:'getset_descriptor'
    write_color_array:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    ...
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetTextureFileName(self) -> str: ...
    def GetUseRelativeTexturePath(self) -> bool: ...
    def GetWriteColorArray(self) -> bool: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetColorArrayName(self, _arg:str) -> None: ...
    def SetFileName(self, _arg:str) -> None: ...
    def SetTextureFileName(self, _arg:str) -> None: ...
    def SetUseRelativeTexturePath(self, _arg:bool) -> None: ...
    def SetWriteColorArray(self, _arg:bool) -> None: ...
    def UseRelativeTexturePathOff(self) -> None: ...
    def UseRelativeTexturePathOn(self) -> None: ...
    def WriteColorArrayOff(self) -> None: ...
    def WriteColorArrayOn(self) -> None: ...
...
class vtkPTSReader(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    @staticmethod
    def CanReadFile(name:str) -> bool: ...
    @overload
    @staticmethod
    def CanReadFile(stream:'vtkResourceStream') -> bool: ...
...
class vtkSTLReader(vtkmodules.vtkIOCore.vtkAbstractPolyDataReader):
    ...
    @overload
    @staticmethod
    def CanReadFile(filename:str) -> bool: ...
    @overload
    @staticmethod
    def CanReadFile(stream:'vtkResourceStream') -> bool: ...
