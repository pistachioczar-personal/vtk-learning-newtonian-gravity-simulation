...
class vtkGridAxesActor3D(vtkmodules.vtkRenderingCore.vtkProp3D):
    ...
    def GetGenerateTicks(self) -> bool: ...
    def GetGridBounds(self) -> Tuple[float, float, float, float, float, float]: ...
    def GetLabel(self, axis:int, index:int) -> float: ...
    def GetLabelDisplayOffset(self) -> Tuple[int, int]: ...
    def GetLabelMask(self) -> int: ...
    def GetLabelTextProperty(self, axis:int) -> 'vtkTextProperty': ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetNumberOfLabels(self, axis:int) -> int: ...
    def GetNumberOfXLabels(self) -> int: ...
    def GetNumberOfYLabels(self) -> int: ...
    def GetNumberOfZLabels(self) -> int: ...
    def GetPrecision(self, axis:int) -> int: ...
    def GetProperty(self) -> 'vtkProperty': ...
    def GetRenderedBounds(self, bounds:MutableSequence[float]) -> None: ...
    def GetTitle(self, axis:int) -> str: ...
    def GetTitleTextProperty(self, axis:int) -> 'vtkTextProperty': ...
    def GetUseCustomLabels(self, axis:int) -> bool: ...
    def GetXLabel(self, index:int) -> float: ...
    def GetXLabelTextProperty(self) -> 'vtkTextProperty': ...
    def GetXNotation(self) -> int: ...
    def GetXPrecision(self) -> int: ...
    def GetXTitle(self) -> str: ...
    def GetXTitleTextProperty(self) -> 'vtkTextProperty': ...
    def GetXUseCustomLabels(self) -> bool: ...
    def GetYLabel(self, index:int) -> float: ...
    def GetYLabelTextProperty(self) -> 'vtkTextProperty': ...
    def GetYNotation(self) -> int: ...
    def GetYPrecision(self) -> int: ...
    def GetYTitle(self) -> str: ...
    def GetYTitleTextProperty(self) -> 'vtkTextProperty': ...
    def GetYUseCustomLabels(self) -> bool: ...
    def GetZLabel(self, index:int) -> float: ...
    def GetZLabelTextProperty(self) -> 'vtkTextProperty': ...
    def GetZNotation(self) -> int: ...
    def GetZPrecision(self) -> int: ...
    def GetZTitle(self) -> str: ...
    def GetZTitleTextProperty(self) -> 'vtkTextProperty': ...
    def GetZUseCustomLabels(self) -> bool: ...
    def HasTranslucentPolygonalGeometry(self) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
