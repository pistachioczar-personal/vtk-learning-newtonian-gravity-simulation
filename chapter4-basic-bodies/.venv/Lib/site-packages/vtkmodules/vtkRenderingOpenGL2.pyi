...
class vtkDrawTexturedElements(object):
    ...
    uses_index_buffer:'getset_descriptor'
    def __init__(self) -> None: ...
    def AppendArrayToTexture(self, textureName:'vtkStringToken', array:'vtkDataArray', asScalars:bool=False) -> None: ...
    def AppendElementIndexBuffer(self, indices:'vtkDataArray') -> None: ...
    def BeginArrayRebuild(self) -> None: ...
    def BindArrayToTexture(self, textureName:'vtkStringToken', array:'vtkDataArray', asScalars:bool=False) -> None: ...
    def ClearElementIndexBuffer(self) -> None: ...
...
class vtkDummyGPUInfoList(vtkmodules.vtkRenderingCore.vtkGPUInfoList):
    def __init__(self, **properties:Any) -> None: ...
    @staticmethod
    def CreateOverrideAttributes() -> 'vtkOverrideAttribute': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
...
class vtkOpenGLPolyDataMapper(vtkmodules.vtkRenderingCore.vtkPolyDataMapper):
    ...
    @staticmethod
    def CreateOverrideAttributes() -> 'vtkOverrideAttribute': ...
    def GetMaximumNumberOfTriangles(self, ren:'vtkRenderer') -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkOpenGLRenderWindow(vtkmodules.vtkRenderingCore.vtkRenderWindow):
    ...
    array_texture_buffer_cache:'getset_descriptor'
    ...
    use_generic_open_gl_render_window:'getset_descriptor'
    ...
    def GetArrayTextureBufferCache(self) -> 'vtkOpenGLArrayTextureBufferCache': ...
    ...
    @staticmethod
    def GetUseGenericOpenGLRenderWindow() -> bool: ...
    ...
    @staticmethod
    def SetUseGenericOpenGLRenderWindow(val:bool) -> None: ...
    @overload
...
class vtkHexagonalBokehBlurPass(vtkImageProcessingPass):
    circle_of_confusion_radius:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetCircleOfConfusionRadius(self) -> float: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkHexagonalBokehBlurPass': ...
    def ReleaseGraphicsResources(self, w:'vtkWindow') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkHexagonalBokehBlurPass': ...
    def SetCircleOfConfusionRadius(self, _arg:float) -> None: ...
...
class vtkOpenGLArrayTextureBufferAdapter(object):
    owns_texture:'getset_descriptor'
    pending_reset:'getset_descriptor'
    uploaded:'getset_descriptor'
    @overload
    def __init__(self) -> None: ...
    @overload
    ...
    def GetOwnsTexture(self) -> bool: ...
    def GetPendingReset(self) -> bool: ...
    def GetUploaded(self) -> bool: ...
    def ReleaseGraphicsResources(self, window:'vtkWindow') -> None: ...
    def SetOwnsTexture(self, ownsTexture:bool) -> None: ...
    def SetPendingReset(self, pendingReset:bool) -> None: ...
    def SetUploaded(self, uploaded:bool) -> None: ...
    def Upload(self, renderWindow:'vtkOpenGLRenderWindow', force:bool=False) -> None: ...

class vtkOpenGLArrayTextureBufferCache(vtkmodules.vtkCommonCore.vtkObject):
    cpu_memory_size:'getset_descriptor'
    current_cache_size:'getset_descriptor'
    maximum_cache_size:'getset_descriptor'
    number_of_cached_texture_buffers:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetCPUMemorySize(self) -> int: ...
    def GetCurrentCacheSize(self) -> int: ...
    def GetMaximumCacheSize(self) -> int: ...
    def GetNumberOfCachedTextureBuffers(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkOpenGLArrayTextureBufferCache': ...
    def ReleaseGraphicsResources(self, window:'vtkWindow') -> None: ...
    def RemoveTextureBuffer(self, array:'vtkDataArray', window:'vtkWindow') -> int: ...
    def RemoveUnusedTextureBuffers(self, window:'vtkWindow') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkOpenGLArrayTextureBufferCache': ...
    def SetMaximumCacheSize(self, _arg:int) -> None: ...

class vtkOpenGLBatchedLabeledDataMapper(vtkmodules.vtkRenderingLabel.vtkBatchedLabeledDataMapper):
    label_text_property:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    @staticmethod
    def CreateOverrideAttributes() -> 'vtkOverrideAttribute': ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkOpenGLBatchedLabeledDataMapper': ...
    def ReleaseGraphicsResources(self, __a:'vtkWindow') -> None: ...
    def RenderOpaqueGeometry(self, viewport:'vtkViewport', actor:'vtkActor2D') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkOpenGLBatchedLabeledDataMapper': ...
    @overload
    def SetLabelTextProperty(self, p:'vtkTextProperty', type:int) -> None: ...
    @overload
    def SetLabelTextProperty(self, p:'vtkTextProperty') -> None: ...
...
class vtkOpenGLGlyph3DMapper(vtkmodules.vtkRenderingCore.vtkGlyph3DMapper):
    ...
    number_of_lod_distances:'getset_descriptor'
    number_of_lod_target_reductions:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    @staticmethod
    def CreateOverrideAttributes() -> 'vtkOverrideAttribute': ...
    def GetLODDistance(self, index:int) -> float: ...
    def GetLODTargetReduction(self, index:int) -> float: ...
    def GetMaxNumberOfLOD(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetNumberOfLOD(self) -> int: ...
    def GetNumberOfLODDistances(self) -> int: ...
    def GetNumberOfLODTargetReductions(self) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetLODDistance(self, index:int, distance:float) -> None: ...
    def SetLODDistanceAndTargetReduction(self, index:int, distance:float, targetReduction:float) -> None: ...
    def SetLODTargetReduction(self, index:int, targetReduction:float) -> None: ...
...
class vtkOpenGLLowMemoryPolyDataMapper(vtkmodules.vtkRenderingCore.vtkPolyDataMapper):
    populate_selection_settings:'getset_descriptor'
    supports_selection:'getset_descriptor'
    use_indexed_rendering:'getset_descriptor'
    vbo_shift_scale_method:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AddMod(self, className:str) -> None: ...
    def AddMods(self, classNames:Sequence[str]) -> None: ...
    ...
    def GetSupportsSelection(self) -> bool: ...
    def GetUseIndexedRendering(self) -> bool: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def MapDataArrayToMultiTextureAttribute(self, tname:str, dataArrayName:str, fieldAssociation:int, componentno:int=-1) -> None: ...
    ...
    def SetUseIndexedRendering(self, _arg:bool) -> None: ...
    def SetVBOShiftScaleMethod(self, method:int) -> None: ...
    def ShallowCopy(self, m:'vtkAbstractMapper') -> None: ...
    def UseIndexedRenderingOff(self) -> None: ...
    def UseIndexedRenderingOn(self) -> None: ...
...
class vtkOpenGLState(vtkmodules.vtkCommonCore.vtkObject):
    ...
    shader_cache:'getset_descriptor'
    supports_texture_norm16:'getset_descriptor'
    texture_normalization_helper:'getset_descriptor'
    texture_unit_manager:'getset_descriptor'
    vbo_cache:'getset_descriptor'
    ...
    def GetShaderCache(self) -> 'vtkOpenGLShaderCache': ...
    def GetSupportsTextureNorm16(self) -> bool: ...
    def GetTextureNormalizationHelper(self) -> 'vtkOpenGLTextureNormalizationHelper': ...
    def GetTextureUnitForTexture(self, __a:'vtkTextureObject') -> int: ...
    def GetTextureUnitManager(self) -> 'vtkTextureUnitManager': ...
    def GetVBOCache(self) -> 'vtkOpenGLVertexBufferObjectCache': ...
    ...
    def SetArrayTextureBufferCache(self, cache:'vtkOpenGLArrayTextureBufferCache') -> None: ...
...
class vtkOpenGLTextureNormalizationHelper(vtkmodules.vtkCommonCore.vtkObject):
    class ConversionMode(int):
        CPU:'ConversionMode'
        ComputeShader:'ConversionMode'
        CopyTexImage:'ConversionMode'
        Unsupported:'ConversionMode'
    conversion_mode:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def ConvertShortToFloat(self, sourceData:Pointer, numValues:int, numComps:int, targetTexture:int, width:int, height:int) -> bool: ...
    def ConvertUShortToFloat(self, sourceData:Pointer, numValues:int, numComps:int, targetTexture:int, width:int, height:int) -> bool: ...
    @staticmethod
    def Create(context:'vtkOpenGLRenderWindow') -> 'vtkOpenGLTextureNormalizationHelper': ...
    def GetConversionMode(self) -> 'ConversionMode': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    def IsGPUConversionAvailable(self) -> bool: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkOpenGLTextureNormalizationHelper': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkOpenGLTextureNormalizationHelper': ...

class vtkOpenGLTextureCPUNormalization(vtkOpenGLTextureNormalizationHelper):
    def __init__(self, **properties:Any) -> None: ...
    def ConvertShortToFloat(self, sourceData:Pointer, numValues:int, numComps:int, targetTexture:int, width:int, height:int) -> bool: ...
    def ConvertUShortToFloat(self, sourceData:Pointer, numValues:int, numComps:int, targetTexture:int, width:int, height:int) -> bool: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkOpenGLTextureCPUNormalization': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkOpenGLTextureCPUNormalization': ...

class vtkOpenGLTextureComputeShaderNormalization(vtkOpenGLTextureNormalizationHelper):
    def __init__(self, **properties:Any) -> None: ...
    def ConvertShortToFloat(self, sourceData:Pointer, numValues:int, numComps:int, targetTexture:int, width:int, height:int) -> bool: ...
    def ConvertUShortToFloat(self, sourceData:Pointer, numValues:int, numComps:int, targetTexture:int, width:int, height:int) -> bool: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def Initialize(self, context:'vtkOpenGLRenderWindow') -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkOpenGLTextureComputeShaderNormalization': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkOpenGLTextureComputeShaderNormalization': ...

class vtkOpenGLTextureFramebufferNormalization(vtkOpenGLTextureNormalizationHelper):
    def __init__(self, **properties:Any) -> None: ...
    def ConvertShortToFloat(self, sourceData:Pointer, numValues:int, numComps:int, targetTexture:int, width:int, height:int) -> bool: ...
    def ConvertUShortToFloat(self, sourceData:Pointer, numValues:int, numComps:int, targetTexture:int, width:int, height:int) -> bool: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkOpenGLTextureFramebufferNormalization': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkOpenGLTextureFramebufferNormalization': ...
...
class vtkShaderProgram(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def SetUniform1fv(self, location:int, count:int, f:Sequence[float]) -> bool: ...
    ...
    @overload
    def SetUniform3f(self, location:int, v:Sequence[float]) -> bool: ...
    ...
    @overload
    def SetUniform4f(self, location:int, v:Sequence[float]) -> bool: ...
    @overload
    def SetUniform4fv(self, name:str, count:int, f:Sequence[float]) -> bool: ...
    @overload
    def SetUniform4fv(self, location:int, count:int, f:Sequence[float]) -> bool: ...
    ...
    @overload
    def SetUniformMatrix(self, location:int, v:'vtkMatrix3x3') -> bool: ...
    @overload
    def SetUniformMatrix(self, location:int, v:'vtkMatrix4x4') -> bool: ...
    @overload
    def SetUniformMatrix3x3(self, name:str, v:MutableSequence[float]) -> bool: ...
    @overload
    def SetUniformMatrix3x3(self, location:int, v:MutableSequence[float]) -> bool: ...
    @overload
    def SetUniformMatrix4x4(self, name:str, v:MutableSequence[float]) -> bool: ...
    @overload
    def SetUniformMatrix4x4(self, location:int, v:MutableSequence[float]) -> bool: ...
    @overload
    def SetUniformMatrix4x4v(self, name:str, count:int, v:MutableSequence[float]) -> bool: ...
    @overload
    def SetUniformMatrix4x4v(self, location:int, count:int, v:MutableSequence[float]) -> bool: ...
    @overload
    def SetUniformf(self, name:str, v:float) -> bool: ...
    @overload
    def SetUniformf(self, location:int, v:float) -> bool: ...
    @overload
    def SetUniformi(self, name:str, v:int) -> bool: ...
    @overload
    def SetUniformi(self, location:int, v:int) -> bool: ...
...
class vtkTextureObject(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def EmulateTextureBufferWith2DTexturesFromRaw(self, numValues:int, numComps:int, dataType:int, data:Pointer) -> bool: ...
    ...
    def UpdateTextureBuffer2DRegion(self, texelOffset:int, numTexels:int, numComps:int, dataType:int, data:Pointer) -> bool: ...
