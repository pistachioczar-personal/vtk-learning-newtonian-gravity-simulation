...
class vtkCameraManipulator(vtkmodules.vtkCommonCore.vtkObject):
    class MouseButtonType(int):
        Left:'MouseButtonType'
        Middle:'MouseButtonType'
        Right:'MouseButtonType'
    alt:'getset_descriptor'
    center_of_rotation:'getset_descriptor'
    control:'getset_descriptor'
    manipulator_name:'getset_descriptor'
    mouse_button:'getset_descriptor'
    mouse_motion_factor:'getset_descriptor'
    shift:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AltOff(self) -> None: ...
    def AltOn(self) -> None: ...
    def ControlOff(self) -> None: ...
    def ControlOn(self) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetAlt(self) -> bool: ...
    def GetCenterOfRotation(self) -> Tuple[float, float, float]: ...
    def GetControl(self) -> bool: ...
    def GetManipulatorName(self) -> str: ...
    def GetMouseButton(self) -> 'MouseButtonType': ...
    def GetMouseMotionFactor(self) -> float: ...
    ...
    def NewInstance(self) -> 'vtkCameraManipulator': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', iren:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', iren:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, iren:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, iren:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', iren:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkCameraManipulator': ...
    def SetAlt(self, _arg:bool) -> None: ...
    @overload
    def SetCenterOfRotation(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetCenterOfRotation(self, _arg:Sequence[float]) -> None: ...
    def SetControl(self, _arg:bool) -> None: ...
    def SetManipulatorName(self, _arg:str) -> None: ...
    def SetMouseButton(self, _arg:'MouseButtonType') -> None: ...
    def SetMouseMotionFactor(self, _arg:float) -> None: ...
    def SetShift(self, _arg:bool) -> None: ...
    def ShiftOff(self) -> None: ...
    def ShiftOn(self) -> None: ...
    def StartInteraction(self) -> None: ...
...
class vtkInteractorStyleManipulator(vtkmodules.vtkRenderingCore.vtkInteractorStyle):
    camera_manipulators:'getset_descriptor'
    manipulators:'getset_descriptor'
    mouse_motion_factor:'getset_descriptor'
    mouse_wheel_zooms_to_cursor:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AddManipulator(self, m:'vtkCameraManipulator') -> None: ...
    def Dolly(self) -> None: ...
    def FindManipulator(self, button:int, alt:bool, control:bool, shift:bool) -> 'vtkCameraManipulator': ...
    def GetCameraManipulators(self) -> 'vtkCollection': ...
    def GetMouseMotionFactor(self) -> float: ...
    def GetMouseWheelZoomsToCursor(self) -> bool: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkInteractorStyleManipulator': ...
    def OnKeyDown(self) -> None: ...
    def OnKeyUp(self) -> None: ...
    def OnLeftButtonDown(self) -> None: ...
    def OnLeftButtonUp(self) -> None: ...
    ...
    def OnRightButtonDown(self) -> None: ...
    def OnRightButtonUp(self) -> None: ...
    def RemoveAllManipulators(self) -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkInteractorStyleManipulator': ...
    def SetMouseMotionFactor(self, _arg:float) -> None: ...
    def SetMouseWheelZoomsToCursor(self, _arg:bool) -> None: ...
...
class vtkJoystickFly(vtkCameraManipulator):
    FlyAnimationStepEvent:int
    fly_speed:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetFlySpeed(self) -> float: ...
    def GetFlySpeedMaxValue(self) -> float: ...
    def GetFlySpeedMinValue(self) -> float: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkJoystickFly': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkJoystickFly': ...
    def SetFlySpeed(self, _arg:float) -> None: ...
    def StartInteraction(self) -> None: ...

class vtkJoystickFlyIn(vtkJoystickFly):
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkJoystickFlyIn': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkJoystickFlyIn': ...

class vtkJoystickFlyOut(vtkJoystickFly):
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkJoystickFlyOut': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkJoystickFlyOut': ...
...
class vtkTableTopRotate(vtkCameraManipulator):
    simultaneously_adjust_azimuth_elevation:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetSimultaneouslyAdjustAzimuthElevation(self) -> bool: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTableTopRotate': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTableTopRotate': ...
    def SetSimultaneouslyAdjustAzimuthElevation(self, _arg:bool) -> None: ...
    def SimultaneouslyAdjustAzimuthElevationOff(self) -> None: ...
    def SimultaneouslyAdjustAzimuthElevationOn(self) -> None: ...
    def StartInteraction(self) -> None: ...

class vtkTrackballEnvironmentRotate(vtkCameraManipulator):
    def __init__(self, **properties:Any) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTrackballEnvironmentRotate': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTrackballEnvironmentRotate': ...
    def StartInteraction(self) -> None: ...

class vtkTrackballMoveActor(vtkCameraManipulator):
    class MoveActorEvents(int): ...
    ApplyActiveSourcePositionEvent:'MoveActorEvents'
    RequestActiveSourceBoundsEvent:'MoveActorEvents'
    RequestActiveSourcePositionEvent:'MoveActorEvents'
    def __init__(self, **properties:Any) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTrackballMoveActor': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', iren:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', iren:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTrackballMoveActor': ...
    def StartInteraction(self) -> None: ...

class vtkTrackballMultiRotate(vtkCameraManipulator):
    def __init__(self, **properties:Any) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTrackballMultiRotate': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTrackballMultiRotate': ...
    def StartInteraction(self) -> None: ...

class vtkTrackballPan(vtkCameraManipulator):
    def __init__(self, **properties:Any) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTrackballPan': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', iren:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', iren:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, __a:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, __a:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', iren:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTrackballPan': ...
    def StartInteraction(self) -> None: ...

class vtkTrackballRoll(vtkCameraManipulator):
    def __init__(self, **properties:Any) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTrackballRoll': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTrackballRoll': ...
    def StartInteraction(self) -> None: ...

class vtkTrackballRotate(vtkCameraManipulator):
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTrackballRotate': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, iren:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, iren:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTrackballRotate': ...
    def StartInteraction(self) -> None: ...

class vtkTrackballZoom(vtkCameraManipulator):
    use_dolly_for_perspective_projection:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def EndInteraction(self) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTrackballZoom': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnButtonUp(self, __a:int, __b:int, __c:'vtkRenderer', __d:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyDown(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnKeyUp(self, rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTrackballZoom': ...
    def SetUseDollyForPerspectiveProjection(self, _arg:bool) -> None: ...
    def StartInteraction(self) -> None: ...
    def UseDollyForPerspectiveProjectionOff(self) -> None: ...
    def UseDollyForPerspectiveProjectionOn(self) -> None: ...

class vtkTrackballZoomToMouse(vtkTrackballZoom):
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTrackballZoomToMouse': ...
    def OnButtonDown(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    def OnMouseMove(self, x:int, y:int, ren:'vtkRenderer', rwi:'vtkRenderWindowInteractor') -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTrackballZoomToMouse': ...
