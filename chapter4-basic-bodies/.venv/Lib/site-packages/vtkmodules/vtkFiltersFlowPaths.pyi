...
class vtkAbstractInterpolatedVelocityField(vtkmodules.vtkCommonMath.vtkFunctionSet):
    ...
    def Initialize(self, compDS:'vtkCompositeDataSet', initCellLocator:int=...) -> None: ...
...
class vtkEvenlySpacedStreamlines2D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def SetCellLocator(self, __a:'vtkAbstractCellLocator') -> None: ...
    def SetCellLocatorToJumpAndWalkCellLocator(self) -> None: ...
    def SetCellLocatorToModifiedBSPTree(self) -> None: ...
...
class vtkParticleTracerBase(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def SetCellLocator(self, __a:'vtkAbstractCellLocator') -> None: ...
    def SetCellLocatorToJumpAndWalkCellLocator(self) -> None: ...
    def SetCellLocatorToStaticCellLocator(self) -> None: ...
