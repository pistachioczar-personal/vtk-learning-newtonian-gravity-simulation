...
class vtkCommunicator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def AllToAllVVoidArray(self, sendBuffer:Pointer, sendCounts:Sequence[int] , sendOffsets:Sequence[int], recvBuffer:Pointer, recvCounts:Sequence[int], recvOffsets:Sequence[int], type:int) -> int: ...
