...
class vtkDGArrayOutputAccessor(object):
    ...
    def SetResult(self, result:'vtkDoubleArray') -> None: ...
    def size(self) -> int: ...

class vtkDGArraysInputAccessor(object):
    cell_ids:'getset_descriptor'
    key:'getset_descriptor'
    rst:'getset_descriptor'
    @overload
    def __init__(self) -> None: ...
    @overload
    ...
    def IsAtEnd(self) -> bool: ...
    def Restart(self) -> None: ...
    def SetCellIds(self, cellIds:'vtkDataArray') -> None: ...
    def SetRST(self, rst:'vtkDataArray') -> None: ...
    def size(self) -> int: ...
...
class vtkDGCell(vtkmodules.vtkCommonDataModel.vtkCellMetadata):
    ...
    def GetSignedParametricDistance(self, rst:'vtkVector3d') -> float: ...
    def IsA(self, type:str) -> int: ...
...
class vtkDGSummaryInformationResponder(object):
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkDGSummaryInformationResponder': ...
    def Query(self, query:'vtkCellGridSummaryInformationQuery', cellType:'vtkCellMetadata', caches:'vtkCellGridResponders') -> bool: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkDGSummaryInformationResponder': ...
