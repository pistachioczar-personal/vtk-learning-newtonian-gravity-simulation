...
class vtkAggregateDataSetFilter(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    class TargetProcessType(int): ...
    PROCESS_WITH_MOST_POINTS:'TargetProcessType'
    ROOT_PROCESS:'TargetProcessType'
    merge_points:'getset_descriptor'
    number_of_target_processes:'getset_descriptor'
    target_process:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    ...
    def GetTargetProcess(self) -> int: ...
    def GetTargetProcessMaxValue(self) -> int: ...
    def GetTargetProcessMinValue(self) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetTargetProcess(self, _arg:int) -> None: ...
    def SetTargetProcessToProcessWithMostPoints(self) -> None: ...
    def SetTargetProcessToRootProcess(self) -> None: ...
...
class vtkGeometryFilterDispatcher(vtkmodules.vtkCommonExecutionModel.vtkDataObjectAlgorithm):
    block_colors_distinct_values:'getset_descriptor'
    controller:'getset_descriptor'
    feature_angle:'getset_descriptor'
    generate_cell_normals:'getset_descriptor'
    generate_feature_edges:'getset_descriptor'
    generate_point_normals:'getset_descriptor'
    generate_process_ids:'getset_descriptor'
    hide_internal_amr_faces:'getset_descriptor'
    match_boundaries_ignoring_cell_order:'getset_descriptor'
    nonlinear_subdivision_level:'getset_descriptor'
    outline_flag:'getset_descriptor'
    pass_through_cell_ids:'getset_descriptor'
    pass_through_point_ids:'getset_descriptor'
    splitting:'getset_descriptor'
    triangulate:'getset_descriptor'
    use_non_overlapping_amr_meta_data_for_outlines:'getset_descriptor'
    use_outline:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    ...
    def GetBlockColorsDistinctValues(self) -> int: ...
    def GetController(self) -> 'vtkMultiProcessController': ...
    def GetFeatureAngle(self) -> float: ...
    def GetGenerateCellNormals(self) -> bool: ...
    def GetGenerateFeatureEdges(self) -> bool: ...
    def GetGeneratePointNormals(self) -> bool: ...
    def GetGenerateProcessIds(self) -> bool: ...
    def GetHideInternalAMRFaces(self) -> bool: ...
    def GetMatchBoundariesIgnoringCellOrder(self) -> int: ...
    def GetNonlinearSubdivisionLevel(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOutlineFlag(self) -> bool: ...
    def GetPassThroughCellIds(self) -> bool: ...
    def GetPassThroughPointIds(self) -> bool: ...
    def GetSplitting(self) -> bool: ...
    def GetTriangulate(self) -> bool: ...
    def GetUseNonOverlappingAMRMetaDataForOutlines(self) -> bool: ...
    def GetUseOutline(self) -> bool: ...
    def HideInternalAMRFacesOff(self) -> None: ...
    def HideInternalAMRFacesOn(self) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkGeometryFilterDispatcher': ...
    ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkGeometryFilterDispatcher': ...
    def SetBlockColorsDistinctValues(self, _arg:int) -> None: ...
    def SetController(self, __a:'vtkMultiProcessController') -> None: ...
    def SetFeatureAngle(self, __a:float) -> None: ...
    def SetGenerateCellNormals(self, __a:bool) -> None: ...
    def SetGenerateFeatureEdges(self, __a:bool) -> None: ...
    def SetGeneratePointNormals(self, __a:bool) -> None: ...
    def SetGenerateProcessIds(self, _arg:bool) -> None: ...
    def SetHideInternalAMRFaces(self, _arg:bool) -> None: ...
    def SetMatchBoundariesIgnoringCellOrder(self, __a:int) -> None: ...
    def SetNonlinearSubdivisionLevel(self, __a:int) -> None: ...
    def SetPassThroughCellIds(self, __a:bool) -> None: ...
    def SetPassThroughPointIds(self, __a:bool) -> None: ...
    def SetSplitting(self, __a:bool) -> None: ...
    def SetTriangulate(self, _arg:bool) -> None: ...
    def SetUseNonOverlappingAMRMetaDataForOutlines(self, _arg:bool) -> None: ...
    def SetUseOutline(self, _arg:bool) -> None: ...
    def SplittingOff(self) -> None: ...
    def SplittingOn(self) -> None: ...
    def TriangulateOff(self) -> None: ...
    def TriangulateOn(self) -> None: ...
    def UseNonOverlappingAMRMetaDataForOutlinesOff(self) -> None: ...
    def UseNonOverlappingAMRMetaDataForOutlinesOn(self) -> None: ...
    def UseOutlineOff(self) -> None: ...
    def UseOutlineOn(self) -> None: ...
...
class vtkPTemporalPathLineFilter(vtkmodules.vtkFiltersGeneral.vtkTemporalPathLineFilter):
    controller:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetController(self) -> 'vtkMultiProcessController': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkPTemporalPathLineFilter': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkPTemporalPathLineFilter': ...
    def SetController(self, __a:'vtkMultiProcessController') -> None: ...
