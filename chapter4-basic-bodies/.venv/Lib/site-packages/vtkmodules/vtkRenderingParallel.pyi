...
class vtkSynchronizedRenderers(vtkmodules.vtkCommonCore.vtkObject):
    ...
    independent_viewers:'getset_descriptor'
    ...
    def GetIndependentViewers(self) -> 'vtkIndependentViewerCollection': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    def SetIndependentViewers(self, _arg:'vtkIndependentViewerCollection') -> None: ...
...
class vtkIndependentViewerCollection(vtkmodules.vtkCommonCore.vtkObject):
    number_of_eye_separations:'getset_descriptor'
    number_of_eye_transforms:'getset_descriptor'
    number_of_independent_viewers:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetEyeSeparation(self, i:int) -> float: ...
    def GetEyeTransform(self, i:int, valuesOut:MutableSequence[float]) -> None: ...
    def GetNumberOfEyeSeparations(self) -> int: ...
    def GetNumberOfEyeTransforms(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetNumberOfIndependentViewers(self) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkIndependentViewerCollection': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkIndependentViewerCollection': ...
    def SetEyeSeparation(self, i:int, separation:float) -> None: ...
    def SetEyeTransform(self, i:int, vals:Sequence[float]) -> None: ...
    def SetNumberOfEyeSeparations(self, n:int) -> None: ...
    def SetNumberOfEyeTransforms(self, n:int) -> None: ...
    def SetNumberOfIndependentViewers(self, n:int) -> None: ...
