...
class vtkBatchedLabeledDataMapper(vtkLabeledDataMapper):
    class TextAnchorTypes(int): ...
    Center:'TextAnchorTypes'
    LeftEdge:'TextAnchorTypes'
    LowerEdge:'TextAnchorTypes'
    LowerLeft:'TextAnchorTypes'
    LowerRight:'TextAnchorTypes'
    RightEdge:'TextAnchorTypes'
    UpperEdge:'TextAnchorTypes'
    UpperLeft:'TextAnchorTypes'
    UpperRight:'TextAnchorTypes'
    ...
    def GetTextAnchorMaxValue(self) -> int: ...
    def GetTextAnchorMinValue(self) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkBatchedLabeledDataMapper': ...
    def ReleaseGraphicsResources(self, __a:'vtkWindow') -> None: ...
    ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkBatchedLabeledDataMapper': ...
    @overload
