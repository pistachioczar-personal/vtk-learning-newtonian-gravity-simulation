    ...
    for module_name in pending:
        ...
        for import_name in MODULE_MAPPER.get(module_name, []):
            try:
                ...
                # The module may not be available (e.g. numpy not installed
                # or Python files not yet copied during the build).  Skip
                # the override registration silently; core VTK functionality
                # is unaffected.
                pass
