...
class vtkCameraOrientationWidget(vtkAbstractWidget):
    ...
    use_center_of_rotation:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    ...
    def GetUseCenterOfRotation(self) -> bool: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetUseCenterOfRotation(self, _arg:bool) -> None: ...
    def ShouldResetCameraOff(self) -> None: ...
    def ShouldResetCameraOn(self) -> None: ...
    def SquareResize(self) -> None: ...
    def UseCenterOfRotationOff(self) -> None: ...
    def UseCenterOfRotationOn(self) -> None: ...
